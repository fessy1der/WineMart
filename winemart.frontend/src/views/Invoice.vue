<template>
  <div>
    ...
    <div class="invoice-step" v-if="invoiceStep === 1">
      ...
      <div v-if="customers.length" class="invoice-step-detail">
        ...
        <select
          ...
          id="customer"
        >
          <option disabled value="">Please choose a Customer</option>
    ...
    <div class="invoice-step" v-if="invoiceStep === 3">
      ...
      <app-button @button:click="submitInvoice">Submit Invoice</app-button>
      <hr />
    ...
    <div class="invoice-steps-actions">
      <app-button @button:click="prev" :disabled="!canGoPrev"
        >Previous</app-button
      >
      <app-button @button:click="next" :disabled="!canGoNext"
        >Next</app-button
      >
      <app-button @button:click="startOver">Start Over</app-button>
    </div>
  </div>
</template>
